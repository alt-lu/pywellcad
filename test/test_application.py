...
import pathlib
import wellcad
from wellcad.borehole import Borehole

class TestApplication(unittest.TestCase):
    def setUp(self):
        self.app = wellcad.Application()
    ...
    def test_get_active_borehole(self):
        self.app.new_borehole()
        self.assertIsInstance(self.app.get_active_borehole(), Borehole)
    
    def test_get_borehole(self):
        self.app.new_borehole()
        self.assertIsInstance(self.app.get_borehole(0), Borehole)
    ...
    def test_file_import(self):
        ...
        self.assertIsInstance(borehole, Borehole)
        self.app.close_borehole(False)
    ...
    def test_multi_file_with_comma(self):
        raise RuntimeError("The interface won't allow loading of files with commas in the filename")
