...
class Borehole(DispatchWrapper):
    _DISPATCH_METHODS = ("Log", "ApplyStructureTrueToApparentCorrection", "ApplyStructureApparentToTrueCorrection",
                         ...
                         "CreateLinkedLog", "HydrostaticPressure")
    ...
    def hydrostatic_pressure(self, config=None):
        """Computes the hydrostatic pressure using the method and parameters specified in the configuration file.
        ...
        -------
        Log
            A log containing the hydrostatic pressure.
        """
        return Log(self._dispatch.HydrostaticPressure(config))