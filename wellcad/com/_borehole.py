...
class Borehole(DispatchWrapper):
    _DISPATCH_METHODS = ("Log", "ApplyStructureTrueToApparentCorrection", "ApplyStructureApparentToTrueCorrection",
                         ...
                         "CreateLinkedLog", "OverburdenPressure")
    ...
    def overburden_pressure(self, config=None):
        """Computes the overburden pressure using the method and parameters specified in the configuration file.
        ...
        config : str, optional
            ...
            [OverburdenPressure]
            ; method : one of : 0 (constant), 1 (density); default = 0
        ...
        -------
        Log
            A log containing the overburden pressure.
        """
        return Log(self._dispatch.OverburdenPressure(config))